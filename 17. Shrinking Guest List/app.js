...
var dinnerGuests = ["Haider", "Nasir", "Siddique", "Yousuf", "Mansoor", "Asif", "Amin"];
...
for (var i = 0; i < dinnerGuests.length; i++) {
    console.log("Dear ".concat(dinnerGuests[i], ", you're still invited to dinner!"));
}
